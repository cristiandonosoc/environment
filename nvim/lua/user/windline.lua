...
-- Heavily based on the evil lua sample.
-- https://github.com/windwp/windline.nvim/blob/master/lua/wlsample/evil_line.lua
...
basic.lsp_signature = {
	...
	text = function(_)
		...
		local sig = lsp_signature.status_line(breakpoint_width)
		if sig.label == "" then
			return ""
		end
