...
keymap("n", "<leader>g", "<cmd>lua require('telescope.builtin').live_grep({ additional_args = { '--glob', '!third_party/**' } })<cr>", options)
...
keymap("n", "<A-G>", "<cmd>vs | lua vim.lsp.buf.definition()<cr>", options)
